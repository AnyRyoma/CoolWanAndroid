package com.ryoma.coolwanandroid.di.module;

import com.ryoma.coolwanandroid.app.App;
import com.ryoma.coolwanandroid.app.Constant;
import com.ryoma.coolwanandroid.model.http.api.CollectApis;
import com.ryoma.coolwanandroid.model.http.api.HomeApis;
import com.ryoma.coolwanandroid.model.http.api.PersonApis;
import com.ryoma.coolwanandroid.model.http.api.ProjectApis;
import com.ryoma.coolwanandroid.model.http.api.SearchApis;
import com.ryoma.coolwanandroid.model.http.api.SystemApis;
import com.ryoma.coolwanandroid.model.http.api.VersionApi;
import com.ryoma.coolwanandroid.model.http.api.WxApis;
import com.ryoma.coolwanandroid.model.http.interceptor.CacheInterceptor;
import com.ryoma.coolwanandroid.model.http.interceptor.ReadCookiesInterceptor;
import com.ryoma.coolwanandroid.model.http.interceptor.SaveCookiesInterceptor;
import com.ryoma.coolwanandroid.model.ssl.SSLSocketCompatFactory;
import com.ryoma.coolwanandroid.model.ssl.TrustAllCert;
