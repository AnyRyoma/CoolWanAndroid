...
import com.ryoma.coolwanandroid.base.activity.BaseActivity;
...
public class SystemArticlesActivity extends BaseActivity {
    ...
    private void getData() {
        ...
        mFirstSystemName = intent.getStringExtra(Constant.KEY_SYSTEM_FIRST_NAME);
        mSecondSystemNameList = intent.getStringArrayListExtra(Constant.KEY_SYSTEM_SECOND_NAME_LIST);
        mIdList = intent.getIntegerArrayListExtra(Constant.KEY_SYSTEM_SECOND_ID_LIST);
    }
    ...
    public static void startActivityByData(Context context,
        ...
        intent.putExtra(Constant.KEY_SYSTEM_FIRST_NAME, firstSystemName);
        intent.putStringArrayListExtra(Constant.KEY_SYSTEM_SECOND_NAME_LIST, (ArrayList<String>) secondSystemNameList);
        intent.putIntegerArrayListExtra(Constant.KEY_SYSTEM_SECOND_ID_LIST, (ArrayList<Integer>) idList);
