...
import com.example.coolwanandroid.di.component.activity.DaggerMainActivityComponent;
...
import com.example.coolwanandroid.base.activity.BaseMvpActivity;
import com.example.coolwanandroid.base.fragment.BaseFragment;
import com.example.coolwanandroid.contract.MainContract;
import com.example.coolwanandroid.di.component.activity.MainActivityComponent;
import com.example.coolwanandroid.presenter.MainActivityPresenter;
import com.example.coolwanandroid.utils.CommonUtils;
import com.example.coolwanandroid.utils.DownloadUtil;
...
import com.example.coolwanandroid.widget.VersionUpdateDialog;
...
public class MainActivity extends BaseMvpActivity<MainActivityPresenter> implements MainContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (isNightChange) {
                mBottomBnv.setSelectedItemId(R.id.personItem);
            }
